...
this policy has changed, in writing, in CONTRIBUTING.md.

**Before this text is ever used to collect a real signature, it must be
reviewed by a lawyer.** The draft below is deliberately conservative and
modeled on common ICLA patterns, but it has not had that review.

---

Thank you for your interest in contributing to a FluxCompute open-source
project ("**We**" or "**Us**"). This Individual Contributor License
Agreement ("**Agreement**") documents the rights granted by contributors to
Us. To make this document effective, please sign it and submit it to Us as
instructed by the project maintainers.
...
Us for inclusion in, or documentation of, any product owned or managed by Us
...
**and to relicense Your Contributions and such derivative works, in whole or
in part, under any license terms We choose**, including terms different
from those of the Work at the time of the Contribution.
...
- Each Contribution is Your original creation, or You have identified any
  third-party material and its license terms in the Contribution itself.
- You are not aware of any claim that any Contribution infringes a third
  party's intellectual property rights.

## 5. No Obligation

You understand that the decision to include a Contribution in any product is
entirely at Our discretion, and this Agreement does not obligate Us to
include Your Contribution in any product.

## 6. Disclaimer

Your Contribution is provided "as is." You make no warranties, express or
implied, including without limitation any warranty of merchantability or
fitness for a particular purpose, except as required by law.
